            ...
            <div>
                <div className={classes.member}>
                    <div className={classes.member__shape}>
                        <figcaption className={classes.member__shape__caption}>Tomasz Jankowski<br /> Prezes Zarządu</figcaption>
                        <img src="https://golfguru.pl/wp-content/uploads/2018/07/Adrian-Meronk-ambasador-turnieju-Kram-Junior-Open-2.jpg"
                            ...
                            className={classes.member__shape__img}
                            />
                    </div>   
                    <p>
                ...
                <div className={classes.member}>
                    <div className={classes.member__shape}>
                        <figcaption className={classes.member__shape__caption}>Aleksander Barańczyk<br /> Skarbnik</figcaption>
                ...
                <div className={classes.member}>
                    <div className={classes.member__shape}>
                        <figcaption className={classes.member__shape__caption}>Bogdan Jaroszewski<br /> Organizator Imprez</figcaption>
